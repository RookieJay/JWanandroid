 ...
 * ================================================
 */
public abstract class BaseFragment<P extends IPresenter> extends Fragment implements IFragment, FragmentLifecycleable, HandleBackInterface {
    ...
    public void onAttach(Context context) {
        ...
        mContext = context;
        Timber.e("%s-onAttach", TAG);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Timber.e("%s-onCreateView", TAG);
    ...
    public void onResume() {
        Timber.e("%s-onResume", TAG);
        super.onResume();
    }

    @Override
    public void onPause() {
        Timber.e("%s-onPause", TAG);
        super.onPause();
    }
    ...
    public boolean onBackPress() {
        return BackPressUtil.handleBackPress(this);
    }
}
